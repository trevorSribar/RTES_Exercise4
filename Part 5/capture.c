...
// modified by Trevor Sribar in order to get a negitive image
...
static int              frame_count = (NUMBER_FRAMES_KEPT+NUMBER_FRAMES_DROPPED);
...
void yuv2rgb(int y, int u, int v, unsigned char *r, unsigned char *g, unsigned char *b)
{
   ...
   // g -> r 
   // b -> g
   b1 = (298 * c           + 409 * e + 128) >> 8;
   r1 = (298 * c - 100 * d - 208 * e + 128) >> 8;
   g1 = (298 * c + 516 * d           + 128) >> 8;
